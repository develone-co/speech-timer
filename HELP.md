...
**Westlake Toastmasters Speech Timing Tool — v1.3.2b**
...
| v1.3.2b | Dark mode fix (persists through phases), settings redesign, overtime UX, wake lock, timer script updates, demo finish button |
